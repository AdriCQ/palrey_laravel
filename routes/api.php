...
Route::get('/ann', function (Request $request) {
    ...
    Notification::send(['913493292'], new AnnouncementTelegram($product->image));
    return response()->json(storage_path('app/public/' . $product->image->paths['sm']));
});
